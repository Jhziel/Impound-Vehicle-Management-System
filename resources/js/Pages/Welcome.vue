...
<template>
    <div class="flex h-screen bg-gray-200 dark:bg-slate-900">
        <div class="flex">
            ...
            <div
                class="fixed inset-y-0 left-0 z-30 w-72 overflow-y-auto transition duration-300 transform bg-slate-950 lg:translate-x-0 lg:static lg:inset-0 -translate-x-full"
            >
                <a href="" class="text-white">sadsaddsa</a>
            </div>
        </div>
        ...
        <div class="flex-1 flex flex-col overflow-hidden">
            ...
            >
                <div
                    @click="toggleDark()"
                    class="relative bg-gray-200 dark:bg-gray-500 w-20 cursor-pointer rounded-2xl h-9"
                >
                    <button
                        :class="isDark ? 'translate-x-full bg-gray-400 ' : 'translate-x-0 bg-yellow-300 '"
                        class="absolute text-xl transition-all transform top-1/2 -translate-y-1/2 left-0 w-10 h-10 rounded-full"
                    >
                        <font-awesome-icon
                            :icon="['fas', isDark ? 'moon' : 'sun']" class="text-white"
                        />
                    </button>
                </div>
            </header>
