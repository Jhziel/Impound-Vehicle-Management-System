    ...
    <BaseLayout>
        <div class="relative overflow-x-auto shadow-md sm:rounded-lg mt-10">
            ...
            >
                ...
                <tbody>
                    <tr
                        class="bg-white border-b dark:bg-slate-950 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-slate-600"
                    >
                        <td class="w-4 p-4">
                            <div class="flex items-center">
                                <input
                    ...
                    <tr
                        class="bg-white dark:bg-slate-950 hover:bg-gray-50 dark:hover:bg-gray-600"
                    >
                        <td class="w-4 p-4">
                            <div class="flex items-center">
                                <input
